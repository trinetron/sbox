...
import 'package:sbox/ui/widgets/button_formCard_edit.dart';
                                ...
                                Flexible(
                                  child: TextFormField(
                                      ...
                                      onChanged: (val) => {
                                            ...
                                            context
                                                .read<EditCardProvider>()
                                                .changeDataText(card, 2),
                                            context
                                                .read<EditCardProvider>()
                                                .changeDataText(name, 3),
                                            context
                                                .read<EditCardProvider>()
                                                .changeDataText(dateExp, 5),
                                            context
                                                .read<EditCardProvider>()
                                                .changeDataText(cvv, 6),
                                            context
                                                .read<EditCardProvider>()
                                                .changeDataText(pinAtm, 7),
                                            context
                                                .read<EditCardProvider>()
                                                .changeDataId(id),
